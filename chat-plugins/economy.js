...
function handleBoughtItem(item, user, cost) {
	if (item === 'star') {
		...
		var msg = '**' + user.name + " has bought " + item + ".**";
		this.sendReply('Please contact the admin wolf to get ' + item + '. Use "/tell wolf, avatar image link here". If you want it to be set to any other usernames, mention them as well.');
