...
function handleBoughtItem(item, user, cost) {
	if (item === 'star') {
		...
		var msg = '**' + user.name + " has bought " + item + ".**";
		this.sendReply('Please contact the admins Castform, wolf, or Zeffy to get ' + item + '. Use "/tell wolf, message here". If you bought a title or a join phrase, include your desired join phrase or title. Swap "wolf" with "ctfrm" or "zeffy" to contact a different admin.');
	} else {
		var msg = '**' + user.name + " has bought " + item + ".**";
